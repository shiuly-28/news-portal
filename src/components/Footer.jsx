...
const Footer = () => {
    return (
        <footer className=" text-black pt-10 pb-6 mt-12 font-sans">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-gray-800 pb-8 text-center md:text-left">
                    ...
                    <div className="flex flex-col items-center">
                        <h3 className="text-lg font-semibold mb-4 text-gray-600">বিভাগ</h3>
                    ...
                    {/* যোগাযোগ */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-gray-600">যোগাযোগ</h3>
