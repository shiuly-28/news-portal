...
const National = () => {
  // লোডিং স্টেট (শুরুতে true থাকবে)
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    // ২ সেকেন্ড পর লোডিং শেষ হবে
  ...
  const nationalNewsList = [
    { id: "nat-01", title: "ঢাকায় নতুন মেট্রোরেল রুটের কাজ শুরু হচ্ছে আগামী মাসে", time: "২ ঘণ্টা আগে", img: "https://i.postimg.cc/7YQnJvZ4/images-(1).jpg", summary: "রাজধানীর যানজট নিরসনে নতুন এমআরটি লাইন-৫ এর নির্মাণ কাজ শুরুর ঘোষণা দিয়েছে কর্তৃপক্ষ।" },
    { id: "nat-02", title: "শীতের তীব্রতা বাড়তে পারে, দেশের ৫ জেলায় শৈত্যপ্রবাহের আভাস", time: "৪ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1483921020237-2ff51e8e4b22?q=80&w=300&h=200&fit=crop", summary: "আবহাওয়া অফিস জানিয়েছে, উত্তরাঞ্চলে তাপমাত্রা ১০ ডিগ্রির নিচে নামতে পারে।" },
    { id: "nat-03", title: "বই উৎসব: সারাদেশে শিক্ষার্থীদের হাতে পৌঁছেছে নতুন বই", time: "৫ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?q=80&w=300&h=200&fit=crop", summary: "বছরের প্রথম দিনে উৎসবমুখর পরিবেশে প্রাথমিক ও মাধ্যমিক স্তরের শিক্ষার্থীদের বই বিতরণ করা হয়।" },
    { id: "nat-04", title: "বাজারে চালের দাম স্থিতিশীল রাখতে সরকারের কঠোর মনিটরিং", time: "৬ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1586201375761-83865001e31c?q=80&w=300&h=200&fit=crop", summary: "অবৈধ মজুতদারদের বিরুদ্ধে অভিযান চালাচ্ছে ভ্রাম্যমাণ আদালত।" },
    { id: "nat-05", title: "পর্যটন নগরী কক্সবাজারে পর্যটকের ঢল, তিল ধারণের ঠাঁই নেই", time: "৭ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?q=80&w=300&h=200&fit=crop", summary: "বছরের শুরুতে সমুদ্র সৈকতে লাখো মানুষের সমাগম ঘটেছে।" },
    { id: "nat-06", title: "পদ্মা সেতু দিয়ে রেকর্ড পরিমাণ যানবাহন পারাপার", time: "৮ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1624314138470-5a2f24623f10?q=80&w=300&h=200&fit=crop", summary: "গত ২৪ ঘণ্টায় টোল আদায় হয়েছে ৩ কোটি টাকার বেশি।" },
    { id: "nat-07", title: "দেশের সব হাসপাতালে ডেঙ্গু কর্নার খোলার নির্দেশ", time: "৯ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1584483766114-2cea6facdf57?q=80&w=300&h=200&fit=crop", summary: "ডেঙ্গু আক্রান্ত রোগীর সংখ্যা বাড়তে থাকায় স্বাস্থ্য অধিদপ্তর থেকে এই বিশেষ নির্দেশনা দেওয়া হয়েছে।" },
    { id: "nat-08", title: "সাভারে চামড়া শিল্প নগরীতে কেন্দ্রীয় বর্জ্য শোধনাগার চালুর উদ্যোগ", time: "১০ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?q=80&w=300&h=200&fit=crop", summary: "পরিবেশ দূষণ রোধে ট্যানারি মালিকদের বিসিকের নতুন শর্ত পালনের নির্দেশ দেওয়া হয়েছে।" },
    { id: "nat-09", title: "বিপিএল ২০২৬: সিলেট স্ট্রাইকার্সের দাপুটে জয়ে পয়েন্ট টেবিলে রদবদল", time: "১১ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1531415074968-036ba1b575da?q=80&w=300&h=200&fit=crop", summary: "মাশরাফির সিলেটের বোলিং তোপে অল্প রানেই গুটিয়ে গেল প্রতিপক্ষ।" },
    { id: "nat-10", title: "বঙ্গোপসাগরে নতুন তেল ও গ্যাস অনুসন্ধানে বিদেশি বিনিয়োগের আহ্বান", time: "১২ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1525498128493-380d1990a112?q=80&w=300&h=200&fit=crop", summary: "জ্বালানি নিরাপত্তা নিশ্চিত করতে ব্লু-ইকোনমি জোনে অনুসন্ধানের গতি বাড়াচ্ছে সরকার।" },
    { id: "nat-11", title: "৫জি সেবার পরিধি বাড়াতে আরও ৫টি মোবাইল টাওয়ার স্থাপনের কাজ শুরু", time: "১৩ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1520333789090-1afc82db536a?q=80&w=300&h=200&fit=crop", summary: "বিটিআরসি জানিয়েছে, চলতি বছরের শেষ নাগাদ বড় শহরগুলোতে হাই-স্পিড ৫জি পাওয়া যাবে।" },
    { id: "nat-12", title: "চট্টগ্রাম বন্দরে কন্টেইনার জট কমাতে স্বয়ংক্রিয় স্ক্যানার বসানো হচ্ছে", time: "১৪ ঘণ্টা আগে", img: "https://images.unsplash.com/photo-1494412519320-aa613dfb7738?q=80&w=300&h=200&fit=crop", summary: "আমদানি-রপ্তানি কার্যক্রম দ্রুত করতে কাস্টমস হাউসে নতুন উন্নত প্রযুক্তি যোগ করা হচ্ছে।" }
  ];
          ...
          {loading ? (
            ...
            [...Array(8)].map((_, i) => (
              <div key={i} className="flex gap-3 border-b border-gray-100 pb-4 animate-pulse">
                ...
                <div className="w-24 h-16 bg-gray-200 rounded-sm"></div>
              </div>
            ))
          ) : (
          ...
          {loading ? (
            ...
            <div className="animate-pulse">
              ...
              <div className="grid grid-cols-2 gap-6 mt-6">
                <div className="space-y-3">
                  <div className="w-full h-32 bg-gray-200 rounded-sm"></div>
                  <div className="h-4 bg-gray-100 rounded w-full"></div>
                </div>
                <div className="space-y-3">
                  <div className="w-full h-32 bg-gray-200 rounded-sm"></div>
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-x-6 gap-y-8 mt-6">
                {[
                  { title: "মেট্রোরেলের নতুন রুট উদ্বোধন হতে যাচ্ছে খুব শীঘ্রই", img: "https://i.postimg.cc/Dz7gLMzC/image-329680.jpg" },
                  { title: "সারাদেশে ডেঙ্গু প্রতিরোধে বিশেষ অভিযান শুরু", img: "https://images.unsplash.com/photo-1584483766114-2cea6facdf57?w=200" },
                  { title: "বাজারে আসছে সাশ্রয়ী মূল্যের নতুন স্মার্টফোন", img: "https://i.postimg.cc/zD44KqYJ/walton-20240320205853.jpg" },
                  { title: "প্রাথমিক বিদ্যালয়ে নতুন পাঠ্যক্রম চালু হচ্ছে", img: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=200" }
                ].map((item, idx) => (
                  <div key={idx} className="flex gap-3 group cursor-pointer">
                    <div className="w-24 h-20 flex-shrink-0">
                      <img src={item.img} className="w-full h-full object-cover rounded" alt="thumb" />
                    </div>
                    <h4 className="font-bold text-sm leading-tight group-hover:text-blue-700">{item.title}</h4>
                  </div>
                ))}
              </div>
            ...
            <ul className="space-y-4">
              {loading ? (
                ...
                [
                  ...
                  "রাজধানীর বস্তিতে ভয়াবহ আগুন, নিয়ন্ত্রণে ১০ ইউনিট",
